...
La arquitectura separa capa de datos (ETL Aduanet/INEI), capa de modelos (SARIMA, LSTM, SVR) y capa de negocio (rentabilidad, recomendaciones). La Figura~\ref{fig:arquitectura_app} esquematiza esta arquitectura.

\incluirfigura{figuras/figura8\_2.jpg}{0.92\linewidth}{Arquitectura de la aplicaci\'on (diagrama)}{fig:arquitectura_app}
